				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-8 col-xs-offset-2">
							<input class="form-control" type="text" name="killPhone" id="killPhoneKey" placeholder="填手机号O(∩_∩)O~">
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="http://cdn.bootcss.com/jquery.countdown/2.2.0/jquery.countdown.js"></script>
<!-- 开始写交互逻辑 -->
